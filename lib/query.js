...
/**
 *  Flatten criteria object to a Solr query string.
 *
 * @param {Object} q -
 *
 * @return  {String}
 * @api public
 */
Query.prototype.queryObjectToString = function(q, operator, noEscape) {
  var separator,
      options;
  ...
  if(noEscape) {
    options = {
      encodeURIComponent: function(v) {return v;} // Don't escape.
    }
  }

  return querystring.stringify(q, separator, ':', options);
}
